...
public class NatCalculantAvecDesNombresDecimaux extends NatDeleguantEtat{
	...
	public NatCalculantAvecDesNombresDecimaux(EtatNaturelPur naturelPur) {
		super(naturelPur);
	}

	public Nat creerNatAvecEtat(EtatNaturelPur naturelPur) {
		return new NatCalculantAvecDesNombresDecimaux(naturelPur);
	}
	...
	public Nat produit(Nat x) {
		if(x.equals(creerNatAvecValeur(10))){
